...
from common.utils import init_weight_biases_4dimension, init_weight_biases_2dimensions, shuffle_data, sgd_momentum
...
class CNN:
    ...
    def __init__(self, learning_rate, decays,
                 convolutional_layer, pooling_layer, hidden_layer, num_output, use_momentum=False):
        ...
        if use_momentum:
            updates = sgd_momentum(cost, params, lr=learning_rate, decay=decays)
        else:
